---
name: dwaar-code-reviewer
description: Review a branch or pull request for bugs the author would want to fix, and report each with its file and line. Use when asked to review changes, a branch, or a PR.
---

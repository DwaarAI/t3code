...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerGetSessionRef]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.foldersList]: AuthOrchestrationReadScope,
  [WS_METHODS.foldersCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersAddMember]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersArchiveMember]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersRestoreMember]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersArchive]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersRestore]: AuthOrchestrationOperateScope,
  [WS_METHODS.foldersWriteHandoff]: AuthOrchestrationOperateScope,
